...
- [使用 k3s 搭建轻量 k8s 集群](deploy/k3s/README.md)
  - [k3s 安装实践案例](deploy/k3s/installation-cases.md)
  - [k3s 国内离线安装方法](deploy/k3s/offline-installation.md)
...
- [Pod 性能优化](best-practices/performance-optimization/README.md)
  ...
  - [CPU 绑核](best-practices/performance-optimization/cpu.md)
...
- [弹性伸缩](best-practices/autoscaling/README.md)
  - [灵活调节 HPA 扩缩容速率](best-practices/autoscaling/hpa-velocity.md)
...
- [监控告警](tencent/monitoring/README.md)
  - [Prometheus 采集配置最佳实践](tencent/monitoring/prometheus-scrape-config.md)
  - [超级节点 Pod 监控仪表盘](tencent/monitoring/grafana-dashboard-for-supernode-pod.md)
...
- [常见应用安装与部署](tencent/install-apps/README.md)
  ...
  - [自建 Gitlab 代码仓库](tencent/install-apps/install-gitlab-on-tke.md)
  - [安装 KubeSphere](tencent/install-apps/install-kubesphere-on-tke.md)
