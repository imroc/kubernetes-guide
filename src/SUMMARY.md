...
- [Pod 排障](troubleshooting/pod/README.md)
  - [Terminating](troubleshooting/pod/pod-terminating.md)
    - [device or resource busy](troubleshooting/pod/device-or-resource-busy.md)
  - [Pending](troubleshooting/pod/pod-pending.md)
  - [ContainerCreating 或 Waiting](troubleshooting/pod/pod-containercreating-or-waiting.md)
  - [CrashLoopBackOff](troubleshooting/pod/pod-crash.md)
  - [ImagePullBackOff](troubleshooting/pod/pod-imagepullbackoff.md)
